/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 019009b1dba5b9c5c6e90cd1f82ba7cc)
// Runtime types generated with workerd@1.20251118.0 2025-03-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "IntercomMenuDO" | "IntercomMenuMCP";
	}
	interface Env {
		...
		BROWSER: Fetcher;
		AI: Ai;
		FETCH_MENU_WORKFLOW: Workflow<Parameters<import("./src/index").FetchMenuWorkflow['run']>[0]['payload']>;
	}
}
